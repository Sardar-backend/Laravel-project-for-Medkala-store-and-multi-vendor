...
<link href="./assets/css/dependencies/textEditorQuill.css" rel="stylesheet">
    ...
    <style>
        .color-circle {
            width: 30px; /* اندازه دایره‌ها کوچک‌تر */
            height: 30px; /* اندازه دایره‌ها کوچک‌تر */
            border-radius: 50%;
            display: inline-block;
            margin-right: 8px; /* فاصله کمتر بین دایره‌ها */
            border: 1px solid black; /* اضافه کردن بردر سیاه نازک */
        }

        .color-title {
            font-size: 1rem; /* اندازه فونت عنوان کوچک‌تر */
        }
    </style>

    <!-- دایره‌های رنگی -->
    <div class="flex flex-row items-center justify-start gap-4">
        <h2 class="color-title text-xl font-bold text-gray-800 mb-0">رنگ‌های محصول</h2>

        @foreach ($product->attribute()->where('name', 'رنگ')->get() as $attribute)
            <div class="color-circle" style="background-color: {{$colorMap[$attribute->pivot->value->value]}};"></div>
        @endforeach
    </div>
</div>
        ...
        <h2 class="text-2xl font-semibold text-gray-800 mb-6">صفات محصول</h2>
        ...
        <div class="flex flex-wrap justify-start gap-6">
            ...
            <!-- آیتم 1 -->
            <div class="bg-gray-100 p-4 rounded-md w-1/4 sm:w-1/4 md:w-1/4">
                <div class="text-sm text-gray-500 mb-1">نوع ویژگی</div>
                <div class="text-lg font-semibold text-gray-700">{{$attribute->name}}</div>
                <div class="text-sm text-gray-500 mt-1">مقدار</div>
                <div class="text-lg font-semibold text-gray-800">{{$attribute->pivot->value->value }}</div>
            </div>
            @endforeach
        </div>
