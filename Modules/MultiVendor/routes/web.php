...
Route::group([], function () {
    ...
    Route::get('seller-product-insert', action: [MultiVendorController::class,'seller_product_insert'])->name('seller-product-insert');
    Route::get('seller-product-edit-{id}', action: [MultiVendorController::class,'seller_product_edit'])->name('seller-product-edit');
    ...
    Route::get('seller-smart-discount', action: [MultiVendorController::class,'seller_smart_discount'])->name('seller-smart-discount');
