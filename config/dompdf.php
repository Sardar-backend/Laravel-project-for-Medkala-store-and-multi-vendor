...
return [
    ...
    */
    ...
    'options' => [
         ...
         * Symbol, ZapfDingbats.
         */
        // 'font_dir' => storage_path(path: 'fonts'), // advised by dompdf (https://github.com/dompdf/dompdf/pull/782)
'font_dir' => public_path('assets\font\Vazirmatn-RD-FD-Medium.woff2'), // مسیر فونت‌ها
/**
 ...
 * Note: This directory must exist and be writable by the webserver process.
 */
// 'font_cache' => storage_path(path: 'fonts'),
'font_cache' => public_path('assets\font\Vazirmatn-RD-FD-Medium.woff2'), // کش فونت‌ها
