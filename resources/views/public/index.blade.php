...
@section('content')
  ...
  <main class="max-w-[1500px] mx-auto px-3 md:px-5">
    ...
    <div class="swiper mySwiper bg-red-500 rounded-2xl my-10">
      <div class="swiper-wrapper items-center">
        ...
        @foreach ( $amazing as $product )
            <a href="{{route('product' , ['id' => $product->id])}}" class="card swiper-slide my-2 p-2 md:p-3 bg-white rounded-xl">
            ...
            <div class="space-y-2 text-right">
                ...
                <div>{{$product->price * (100 - $product->discust)/100 }}</div>
                <div>تومان</div>
                </div>
    ...
    <div class="mt-14">
      <!-- TOP SLIDER -->
      <div class="flex justify-between px-1 md:px-10 items-center bg-white py-3 rounded-xl shadow-box scroll-animate">
      ...
      <!-- SLIDER -->
      <div class="containerPSlider swiper scroll-animate">
        <div class="product-slider1 px-1">
          <div class="card-wrapper swiper-wrapper py-2">
            <a href="" class="card swiper-slide my-2 p-2 md:p-4 bg-white rounded-2xl drop-shadow-lg">
              ...
              <div class="image-box mb-6 ">
                <div>
                  <img class="max-w-52 mx-auto" src="./assets/image/products/7.webp" alt="" />
                </div>
              </div>
              <div class="space-y-6">
    ...
    <!-- category 1 -->
    <div class="flex flex-wrap justify-center gap-x-5 sm:gap-x-12 gap-y-5 px-3 md:px-10 my-10 scroll-animate">
      <a href="{{route('Cat_products' , ['name'=>'موبایل'])}}" class="max-w-28 bg-gray-100 hover:bg-red-500 transition flex flex-col justify-between rounded-full p-2 h-32 w-20 group">
        <svg class="w-full group-hover:rotate-6 transition fill-red-600 bg-gray-50 rounded-full p-2" xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="" viewBox="0 0 256 256"><path d="M176,18H80A22,22,0,0,0,58,40V216a22,22,0,0,0,22,22h96a22,22,0,0,0,22-22V40A22,22,0,0,0,176,18Zm10,198a10,10,0,0,1-10,10H80a10,10,0,0,1-10-10V40A10,10,0,0,1,80,30h96a10,10,0,0,1,10,10ZM138,60a10,10,0,1,1-10-10A10,10,0,0,1,138,60Z"></path></svg>
        <div class="text-xs text-center text-zinc-800 group-hover:text-gray-50 mt-2 mb-4">
          موبایل
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'لوازم منزل'])}}" class="max-w-28 bg-gray-100 hover:bg-red-500 transition flex flex-col justify-between rounded-full p-2 h-32 w-20 group">
        <svg class="w-full group-hover:rotate-6 transition fill-red-600 bg-gray-50 rounded-full p-2" xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#e02424" viewBox="0 0 256 256"><path d="M214,90.48V72a38,38,0,0,0-38-38H80A38,38,0,0,0,42,72V90.48a38,38,0,0,0,0,75.05V200a14,14,0,0,0,14,14H200a14,14,0,0,0,14-14V165.53a38,38,0,0,0,0-75ZM80,46h96a26,26,0,0,1,26,26V90.48A38.05,38.05,0,0,0,170,128v2H86v-2A38.05,38.05,0,0,0,54,90.48V72A26,26,0,0,1,80,46ZM208.35,154H208a6,6,0,0,0-6,6v40a2,2,0,0,1-2,2H56a2,2,0,0,1-2-2V160h0a6,6,0,0,0-6-6h-.35A26,26,0,1,1,74,128v40a6,6,0,0,0,12,0V142h84v26a6,6,0,0,0,12,0V128a26,26,0,1,1,26.35,26Z"></path></svg>
        <div class="text-xs text-center text-zinc-800 group-hover:text-gray-50 mt-2 mb-4">
          لوازم منزل
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'اسباب بازی'])}}" class="max-w-28 bg-gray-100 hover:bg-red-500 transition flex flex-col justify-between rounded-full p-2 h-32 w-20 group">
        <svg class="w-full group-hover:rotate-6 transition fill-red-600 bg-gray-50 rounded-full p-2" xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#e02424" viewBox="0 0 256 256"><path d="M92,138a10,10,0,1,1,10-10A10,10,0,0,1,92,138Zm72-20a10,10,0,1,0,10,10A10,10,0,0,0,164,118Zm-11.2,44.92a47,47,0,0,1-49.6,0,6,6,0,0,0-6.4,10.16,59,59,0,0,0,62.4,0,6,6,0,1,0-6.4-10.16ZM230,128A102,102,0,1,1,128,26,102.12,102.12,0,0,1,230,128Zm-12,0a90.11,90.11,0,0,0-87.07-89.95C118.3,55.23,118,71.85,118,72a10,10,0,0,0,20,0,6,6,0,0,1,12,0,22,22,0,0,1-44,0c0-.75.15-15.82,10.14-33.22A90,90,0,1,0,218,128Z"></path></svg>
        <div class="text-xs text-center text-zinc-800 group-hover:text-gray-50 mt-2 mb-4">
          اسباب بازی
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'وسایل ورزش'])}}" class="max-w-28 bg-gray-100 hover:bg-red-500 transition flex flex-col justify-between rounded-full p-2 h-32 w-20 group">
        <svg class="w-full group-hover:rotate-6 transition fill-red-600 bg-gray-50 rounded-full p-2" xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#e02424" viewBox="0 0 256 256"><path d="M128,26A102,102,0,1,0,230,128,102.12,102.12,0,0,0,128,26ZM60,69.09A89.23,89.23,0,0,1,81.78,122H38.2A89.65,89.65,0,0,1,60,69.09ZM38.2,134H81.78A89.23,89.23,0,0,1,60,186.91,89.65,89.65,0,0,1,38.2,134ZM122,217.8a89.66,89.66,0,0,1-53.5-22.34A101.18,101.18,0,0,0,93.82,134H122Zm0-95.8H93.82A101.18,101.18,0,0,0,68.5,60.54,89.66,89.66,0,0,1,122,38.2Zm95.8,0H174.22A89.23,89.23,0,0,1,196,69.09,89.65,89.65,0,0,1,217.8,122ZM134,38.2a89.66,89.66,0,0,1,53.5,22.34A101.18,101.18,0,0,0,162.18,122H134Zm0,179.6V134h28.18a101.18,101.18,0,0,0,25.32,61.46A89.66,89.66,0,0,1,134,217.8Zm62-30.89A89.23,89.23,0,0,1,174.22,134H217.8A89.65,89.65,0,0,1,196,186.91Z"></path></svg>
        <div class="text-xs text-center text-zinc-800 group-hover:text-gray-50 mt-2 mb-4">
          وسایل ورزش
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'غذای پت'])}}" class="max-w-28 bg-gray-100 hover:bg-red-500 transition flex flex-col justify-between rounded-full p-2 h-32 w-20 group">
        <svg class="w-full group-hover:rotate-6 transition fill-red-600 bg-gray-50 rounded-full p-2" xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#e02424" viewBox="0 0 256 256"><path d="M230.14,62.17A33.88,33.88,0,0,0,206,50a34,34,0,1,0-62.81,20,2,2,0,0,1-.23,2.54L72.56,143a2.06,2.06,0,0,1-2.55.23A34,34,0,1,0,50,206a34,34,0,1,0,62.81-20,2,2,0,0,1,.23-2.54l70.4-70.4a2,2,0,0,1,2.54-.23,34,34,0,0,0,44.15-50.65ZM220.6,98.48a22,22,0,0,1-28.24,4.17,14,14,0,0,0-17.4,1.92L104.57,175a14,14,0,0,0-1.92,17.4,22,22,0,1,1-40.41,8.26,6,6,0,0,0-5.93-6.93,7.28,7.28,0,0,0-.93.07,22,22,0,1,1,8.26-40.41A14,14,0,0,0,81,151.43L151.43,81a14,14,0,0,0,1.92-17.4,22,22,0,1,1,40.41-8.26,6,6,0,0,0,6.86,6.86,22,22,0,0,1,20,36.24Z"></path></svg>
        <div class="text-xs text-center text-zinc-800 group-hover:text-gray-50 mt-2 mb-4">
          غذای پت
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'سوپرمارکت'])}}" class="max-w-28 bg-gray-100 hover:bg-red-500 transition flex flex-col justify-between rounded-full p-2 h-32 w-20 group">
        <svg class="w-full group-hover:rotate-6 transition fill-red-600 bg-gray-50 rounded-full p-2" xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#e02424" viewBox="0 0 256 256"><path d="M232,66H198.48l29.76-29.76a6,6,0,1,0-8.48-8.48L190,57.52V24a6,6,0,0,0-12,0V60.15a62,62,0,0,0-77.8,8l0,0h0C60.17,107.4,30.05,201.45,27.38,210a14,14,0,0,0,18.67,18.67c8.5-2.67,102.62-32.81,141.79-72.77a62,62,0,0,0,8-77.84H232a6,6,0,0,0,0-12Zm-52.69,81.41C170,157,157,166,142.69,174.24l-26.46-26.47a6,6,0,1,0-8.49,8.49l24,24c-41.69,22-89,36.82-89.73,37a6.57,6.57,0,0,0-1.06.44,2,2,0,0,1-2.7-2.7A6.57,6.57,0,0,0,38.7,214C39,213,67.55,121.72,104.48,81l35.27,35.26a6,6,0,1,0,8.48-8.48l-35.1-35.1a50,50,0,0,1,66.18,74.74Z"></path></svg>
        <div class="text-xs text-center text-zinc-800 group-hover:text-gray-50 mt-2 mb-4">
          سوپرمارکت
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'پوشاک'])}}" class="max-w-28 bg-gray-100 hover:bg-red-500 transition flex flex-col justify-between rounded-full p-2 h-32 w-20 group">
        <svg class="w-full group-hover:rotate-6 transition fill-red-600 bg-gray-50 rounded-full p-2" xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#e02424" viewBox="0 0 256 256"><path d="M240.37,172.8,138,96l25.59-19.2A6,6,0,0,0,166,72a38,38,0,1,0-76,0,6,6,0,0,0,12,0,26,26,0,0,1,51.82-2.88l-29.32,22-.21.16L15.63,172.8A14,14,0,0,0,24,198H232a14,14,0,0,0,8.39-25.2Zm-6.5,11.83A1.85,1.85,0,0,1,232,186H24a2,2,0,0,1-1.19-3.6L128,103.5l105.17,78.9A1.85,1.85,0,0,1,233.87,184.63Z"></path></svg>
        <div class="text-xs text-center text-zinc-800 group-hover:text-gray-50 mt-2 mb-4">
          پوشاک
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'هدفون'])}}" class="max-w-28 bg-gray-100 hover:bg-red-500 transition flex flex-col justify-between rounded-full p-2 h-32 w-20 group">
        <svg class="w-full group-hover:rotate-6 transition fill-red-600 bg-gray-50 rounded-full p-2" xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#e02424" viewBox="0 0 256 256"><path d="M200.47,64.07A101.37,101.37,0,0,0,128.77,34H128A102,102,0,0,0,26,136v56a22,22,0,0,0,22,22H64a22,22,0,0,0,22-22V152a22,22,0,0,0-22-22H38.2A90.12,90.12,0,0,1,192,72.52,89.41,89.41,0,0,1,217.81,130H192a22,22,0,0,0-22,22v40a22,22,0,0,0,22,22h16a22,22,0,0,0,22-22V136A101.44,101.44,0,0,0,200.47,64.07ZM64,142a10,10,0,0,1,10,10v40a10,10,0,0,1-10,10H48a10,10,0,0,1-10-10V142Zm154,50a10,10,0,0,1-10,10H192a10,10,0,0,1-10-10V152a10,10,0,0,1,10-10h26Z"></path></svg>
        <div class="text-xs text-center text-zinc-800 group-hover:text-gray-50 mt-2 mb-4">
          هدفون
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'لوازم آرایش'])}}" class="max-w-28 bg-gray-100 hover:bg-red-500 transition flex flex-col justify-between rounded-full p-2 h-32 w-20 group">
        <svg class="w-full group-hover:rotate-6 transition fill-red-600 bg-gray-50 rounded-full p-2" xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#e02424" viewBox="0 0 256 256"><path d="M200.12,55.87A102,102,0,1,0,55.88,200.12,102,102,0,1,0,200.12,55.87ZM94,211.37V152a2,2,0,0,1,2-2h64a2,2,0,0,1,2,2v59.37a90.49,90.49,0,0,1-68,0ZM146,138H110V99.71l36-18Zm45.64,53.64h0A90.93,90.93,0,0,1,174,205.39V152a14,14,0,0,0-14-14h-2V72a6,6,0,0,0-8.68-5.37l-48,24A6,6,0,0,0,98,96v42H96a14,14,0,0,0-14,14v53.39a90.93,90.93,0,0,1-17.64-13.75,90,90,0,1,1,127.28,0Z"></path></svg>
        <div class="text-xs text-center text-zinc-800 group-hover:text-gray-50 mt-2 mb-4">
          لوازم آرایش
        </div>
      </a>
    ...
    <!-- off slider -->
    <div class="lg:flex items-center scroll-animate">
      <div class="lg:w-1/3 mb-5 gap-5 lg:mb-0 grid justify-items-center grid-cols-1 sm:grid-cols-2 lg:block">
        <img class="rounded-xl mx-auto" src="./assets/image/sectionImage/13.webp" alt="">
        <img class="rounded-xl lg:hidden" src="./assets/image/sectionImage/14.webp" alt="">
      </div>
      <div class="lg:w-2/3">
        <div class="swiper timerProduct border rounded-xl">
          <div class="swiper-wrapper bg-white">
            <a href="" class="swiper-slide md:flex bg-white">
              <div class="md:w-1/3">
                <img class="max-w-80 w-auto mx-auto rounded-xl" src="./assets/image/products/1.webp" alt="">
              </div>
              <div class="md:w-2/3 flex flex-col justify-center py-5">
                ...
                <div class="clockdiv flex text-red-600 bg-red-100 px-3 py-1 rounded-md mt-6 text-center mx-auto md:mr-28 text-lg" data-date="January 29, 2025 21:00:00">
                  <div>
            ...
            <a href="" class="swiper-slide md:flex bg-white">
              ...
              <div class="md:w-2/3 flex flex-col justify-center py-5">
                ...
                <div class="clockdiv flex text-red-600 mt-6 text-center mx-auto md:mr-28 text-lg" data-date="January 29, 2025 21:00:00">
                  <div>
                    <span class="seconds"></span>
                  </div>
                  <div>
    ...
    <!-- section image 1 -->
    <div class="flex flex-col md:flex-row gap-3 my-16 scroll-animate">
      <a class="md:w-1/2" href="">
        <img class="rounded-2xl" src="./assets/image/sectionImage/7.webp" alt="">
      </a>
      <a class="md:w-1/2" href="">
        <img class="rounded-2xl" src="./assets/image/sectionImage/8.webp" alt="">
      </a>
    </div>
    <!-- category 2 -->
    <div class="flex flex-wrap justify-center gap-x-5 sm:gap-x-16 gap-y-5 px-3 md:px-10 scroll-animate">
      <a href="{{route('Cat_products' , ['name'=>'موبایل'])}}" class="max-w-28">
        <img class="w-full hover:rotate-6 transition" src="./assets/image/category/1.png" alt="">
        <div class="text-xs text-center text-zinc-800 mt-2">
          موبایل
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'کالای دیجیتال'])}}" class="max-w-28">
        <img class="w-full hover:rotate-6 transition" src="./assets/image/category/2.png" alt="">
        <div class="text-xs text-center text-zinc-800 mt-2">
          کالای دیجیتال
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'لوازم خانه'])}}" class="max-w-28">
        <img class="w-full hover:rotate-6 transition" src="./assets/image/category/3.png" alt="">
        <div class="text-xs text-center text-zinc-800 mt-2">
          لوازم خانه
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'پوشاک'])}}" class="max-w-28">
        <img class="w-full hover:rotate-6 transition" src="./assets/image/category/4.png" alt="">
        <div class="text-xs text-center text-zinc-800 mt-2">
          پوشاک
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'کالای سوپرمارکت'])}}" class="max-w-28">
        <img class="w-full hover:rotate-6 transition" src="./assets/image/category/5.png" alt="">
        <div class="text-xs text-center text-zinc-800 mt-2">
          کالای سوپرمارکت
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'دفتر و قلم'])}}" class="max-w-28">
        <img class="w-full hover:rotate-6 transition" src="./assets/image/category/6.png" alt="">
        <div class="text-xs text-center text-zinc-800 mt-2">
          دفتر و قلم
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'محصولات بهداشتی'])}}" class="max-w-28">
        <img class="w-full hover:rotate-6 transition" src="./assets/image/category/7.png" alt="">
        <div class="text-xs text-center text-zinc-800 mt-2">
          محصولات بهداشتی
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'محصولات ورزشی'])}}" class="max-w-28">
        <img class="w-full hover:rotate-6 transition" src="./assets/image/category/8.png" alt="">
        <div class="text-xs text-center text-zinc-800 mt-2">
          محصولات ورزشی
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'ابزارآلات'])}}" class="max-w-28">
        <img class="w-full hover:rotate-6 transition" src="./assets/image/category/9.png" alt="">
        <div class="text-xs text-center text-zinc-800 mt-2">
          ابزارآلات
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'موتور و تجهیزات'])}}" class="max-w-28">
        <img class="w-full hover:rotate-6 transition" src="./assets/image/category/10.png" alt="">
        <div class="text-xs text-center text-zinc-800 mt-2">
          موتور و تجهیزات
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'کالای سنتی'])}}" class="max-w-28">
        <img class="w-full hover:rotate-6 transition" src="./assets/image/category/11.png" alt="">
        <div class="text-xs text-center text-zinc-800 mt-2">
          کالای سنتی
        </div>
      </a>
      <a href="{{route('Cat_products' , ['name'=>'اسباب بازی'])}}" class="max-w-28">
        <img class="w-full hover:rotate-6 transition" src="./assets/image/category/12.png" alt="">
        <div class="text-xs text-center text-zinc-800 mt-2">
          اسباب بازی
        </div>
      </a>
    ...
    <div class="mt-14 ">
      ...
      <div class="flex justify-between px-1 md:px-10 items-center bg-white py-3 rounded-xl shadow-box scroll-animate">
        <div class="px-4 py-2 flex justify-center items-center gap-x-1 text-sm text-zinc-700">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#dc2626" viewBox="0 0 256 256"><path d="M204.24,60.23l-144,144a6,6,0,0,1-8.48-8.48l144-144a6,6,0,1,1,8.48,8.49ZM52,100A34,34,0,1,1,76,110,33.78,33.78,0,0,1,52,100Zm2-24a22,22,0,1,0,6.44-15.56A21.86,21.86,0,0,0,54,76ZM214,180A34,34,0,1,1,204,156,33.78,33.78,0,0,1,214,180Zm-12,0a21.87,21.87,0,0,0-6.44-15.56h0A22,22,0,1,0,202,180Z"></path></svg>
          <span class="text-red-500">
            پرتخفیف ترین
          </span>
          محصولات
      ...
      <!-- SLIDER -->
      <div class="containerPSlider swiper scroll-animate">
        <div class="product-slider2 px-1">
          <div class="card-wrapper swiper-wrapper py-2">
        ...
        <div class="hidden md:block">
          <div class="swiper-btn-next-2 swiper-navbtn"></div>
          <div class="swiper-btn-prev-2 swiper-navbtn"></div>
        </div>
      </div>
    </div>
    <!-- suggested my view -->
     ...
     $secound= $categories[1];
     $Third= $categories[2];
     $last= $categories->last();

     $firstProduct=$first->products();
     $secoundProduct=$secound->products();
     $ThirdProduct=$Third->products();
     $lastProduct= $last->products();

     @endphp
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 bg-white my-10 scroll-animate">
      <div class="bg-white p-3 rounded-tl-xl rounded-tr-xl sm:rounded-tl-none sm:rounded-tr-xl lg:rounded-r-xl sm:border-l border">
        <div class="flex flex-col gap-y-2 mb-5">
          <div class="text-zinc-700">{{$first->name}}</div>
          <div class="text-zinc-400 text-xs">بر اساس بازدیدهای شما</div>
        </div>
        <div class="grid grid-cols-2">
          <div class="border-l border-b py-2"><a href="{{route('product', ['id'=>$firstProduct->first()->id])}}"><img class="max-w-[130px] mx-auto" src="{{$firstProduct->first()->gallery()->first()->image}}" alt=""></a></div>
          <div class="border-b py-2"><a href="{{route('product', ['id'=>$firstProduct[1]->id])}}"><img class="max-w-[130px] mx-auto" src="{{$firstProduct[1]->gallery()->first()->image}}" alt=""></a></div>
          <div class="border-l py-2"><a href="{{route('product', ['id'=>$firstProduct[2]->id])}}"><img class="max-w-[130px] mx-auto" src="{{$firstProduct[2]->gallery()->first()->image}}" alt=""></a></div>
          <div class="py-2"><a href="{{route('product', ['id'=>$firstProduct->last()->id])}}"><img class="max-w-[130px] mx-auto" src="{{$firstProduct->last()->gallery()->first()->image}}" alt=""></a></div>
        </div>
        <div class="flex justify-center text-sm text-red-500 hover:text-red-600 transition mt-5"><a href="{{route('Cat_products' , ['name' =>$first->name])}}">مشاهده همه</a></div>
      </div>
      ...
      <div class="bg-white p-3 sm:border-l border-x sm:border-r-0 sm:border-t sm:rounded-tl-xl border-b lg:border-l-0 lg:rounded-tl-none">
        <div class="flex flex-col gap-y-2 mb-5">
          <div class="text-zinc-700">{{$secound->name}}</div>
          <div class="text-zinc-400 text-xs">بر اساس بازدیدهای شما</div>
        </div>
        <div class="grid grid-cols-2">
          <div class="border-l border-b py-2"><a href="{{route('product', ['id'=>$secoundProduct->first()->id])}}"><img class="max-w-[130px] mx-auto" src="{{$secoundProduct->first()->gallery()->first()->image}}" alt=""></a></div>
          <div class="border-b py-2"><a href="{{route('product', ['id'=>$secoundProduct[1]->id])}}"><img class="max-w-[130px] mx-auto" src="{{$secoundProduct[1]->gallery()->first()->image}}" alt=""></a></div>
          <div class="border-l py-2"><a href="{{route('product', ['id'=>$secoundProduct[2]->id])}}"><img class="max-w-[130px] mx-auto" src="{{$secoundProduct[2]->gallery()->first()->image}}" alt=""></a></div>
          <div class="py-2"><a href="{{route('product', ['id'=>$secoundProduct->last()->id])}}"><img class="max-w-[130px] mx-auto" src="{{$secoundProduct->last()->gallery()->first()->image}}" alt=""></a></div>
        </div>
        <div class="flex justify-center text-sm text-red-500 hover:text-red-600 transition mt-5"><a href="{{route('Cat_products' , ['name' =>$secound->name])}}">مشاهده همه</a></div>
      </div>

      <div class="bg-white p-3 border-x sm:border-l-0 sm:rounded-br-xl border-b lg:border-t lg:rounded-br-none">
        <div class="flex flex-col gap-y-2 mb-5">
          <div class="text-zinc-700">{{$Third->name}}</div>
          <div class="text-zinc-400 text-xs">بر اساس بازدیدهای شما</div>
        </div>
        <div class="grid grid-cols-2">
          <div class="border-l border-b py-2"><a href="{{route('product', ['id'=>$ThirdProduct->first()->id])}}"><img class="max-w-[130px] mx-auto" src="{{$ThirdProduct->first()->gallery()->first()->image}}" alt=""></a></div>
          <div class="border-b py-2"><a href="{{route('product', ['id'=>$ThirdProductProduct[1]->id])}}"><img class="max-w-[130px] mx-auto" src="{{$ThirdProduct[1]->gallery()->first()->image}}" alt=""></a></div>
          <div class="border-l py-2"><a href="{{route('product', ['id'=>$ThirdProductProduct[2]->id])}}"><img class="max-w-[130px] mx-auto" src="{{$ThirdProduct[2]->gallery()->first()->image}}" alt=""></a></div>
          <div class="py-2"><a href="{{route('product', ['id'=>$ThirdProductProduct->last()->id])}}"><img class="max-w-[130px] mx-auto" src="{{$ThirdProduct->last()->gallery()->first()->image}}" alt=""></a></div>
        </div>
        <div class="flex justify-center text-sm text-red-500 hover:text-red-600 transition mt-5"><a href="{{route('Cat_products' , ['name' =>$Third->name])}}">مشاهده همه</a></div>
      </div>

      <div class="bg-white p-3 rounded-bl-xl rounded-br-xl sm:rounded-br-none border-x border-b lg:border-t lg:rounded-tl-xl">
        <div class="flex flex-col gap-y-2 mb-5">
          <div class="text-zinc-700">{{$last->name}}</div>
          <div class="text-zinc-400 text-xs">بر اساس بازدیدهای شما</div>
        </div>
        <div class="grid grid-cols-2">
          <div class="border-l border-b py-2"><a href="{{route('product', ['id'=>$lastProduct->first()->id])}}"><img class="max-w-[130px] mx-auto" src="{{$lastProduct->first()->gallery()->first()->image}}" alt=""></a></div>
          <div class="border-b py-2"><a href="{{route('product', ['id'=>$lastProduct[1]->id])}}"><img class="max-w-[130px] mx-auto" src="{{$lastProduct[1]->gallery()->first()->image}}" alt=""></a></div>
          <div class="border-l py-2"><a href="{{route('product', ['id'=>$lastProduct[2]->id])}}"><img class="max-w-[130px] mx-auto" src="{{$lastProduct[2]->gallery()->first()->image}}" alt=""></a></div>
          <div class="py-2"><a href="{{route('product', ['id'=>$lastProduct->last()->id])}}"><img class="max-w-[130px] mx-auto" src="{{$lastProduct->last()->gallery()->first()->image}}" alt=""></a></div>
        </div>
        <div class="flex justify-center text-sm text-red-500 hover:text-red-600 transition mt-5"><a href="{{route('Cat_products' , ['name' =>$last->name])}}">مشاهده همه</a></div>
      </div>
    ...
    <div class="rounded-2xl mx-auto text-gray-100 ">
      <!-- top blog -->
      <div class="flex justify-between px-5 md:px-10 items-center bg-white py-3 rounded-xl drop-shadow-lg mb-5 scroll-animate">
        <div class="px-4 py-2 flex justify-center items-center gap-x-1 text-sm text-zinc-700">
      ...
      <!-- main blog -->
      <div class="grid grid-cols-1 gap-5 lg:grid-cols-4 sm:grid-cols-2 scroll-animate">
        @foreach ($blogs as $blog)
            ...
            <h2 class="z-10 p-5 absolute -bottom-1 group-hover:bottom-0 group-hover:block transition-all text-right">
                <a href="{{route('blog_single' , ['id' => $blog->id ])}}" class="text-md opacity-90 text-gray-100 transition-all">
                بررسی ساعت هوشمند گلوریمی M1 پرو
                </a>
                <br>
                <a href="{{route('blog_single' , ['id' => $blog->id ])}}" class="text-sm bg-gray-300 bg-opacity-30 hover:bg-opacity-45 w-fit rounded-lg px-3 py-1 opacity-90 text-gray-100 mt-2 hidden group-hover:block transition-all">
                مطالعه بیشتر
                </a>
            </h2>
            </div>
    ...
    <!-- partner company -->
    <div class="bg-white my-10 rounded-2xl border scroll-animate">
      <!-- top companys -->
