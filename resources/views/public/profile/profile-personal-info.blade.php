          ...
          <div>
            ...
            <div class="sm:flex items-center gap-x-5 mt-5">
              <div class="sm:w-1/2 flex flex-col gap-y-1">
                ...
                <textarea placeholder="خودتان را به صورت مختصر معرفی کنید." name="mailTicket" cols="30" rows="7" class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all focus:border-red-400 focus:outline-none"></textarea>
              </div>
