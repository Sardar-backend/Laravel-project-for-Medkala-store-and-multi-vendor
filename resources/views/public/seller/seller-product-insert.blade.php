        ...
        <form action="">
          <div class="mt-7 flex flex-col md:flex-row gap-5">
            <div class="flex flex-col md:w-1/2">
              ...
              <input type="text" class="border border-gray-400 rounded-lg shadow-lg mt-2 w-full p-2 focus:outline-gray-400">
            </div>
            <div class="flex flex-col md:w-1/2">
              <label for="" class="text-gray-800 text-sm">
                نام انگلیسی محصول:
          ...
          <div class="mt-10 flex flex-col md:flex-row gap-5">
            ...
            <div class="flex flex-col md:w-1/2">
              ...
              <select x-cloak id="select" class="hidden">
                ...
                <option value="5">ارغوانی</option>
                <option value="6">سبز</option>
                <option value="7">نیلی</option>
                <option value="8">سفید</option>
              </select>
          ...
          <div class="mt-10 flex flex-col md:flex-row gap-5">
            <div class="flex items-center md:w-1/2">
              ...
              <input type="number" class="border border-gray-400 rounded-lg shadow-lg p-2 focus:outline-gray-400" placeholder="مقدار ماه">
            </div>
            <div class="flex gap-x-3 items-center md:w-1/2">
              <label for="" class="text-gray-800 text-sm">
                زمان ارسال کالا:
              </label>
              <input type="number" class="border border-gray-400 rounded-lg shadow-lg p-2 focus:outline-gray-400" placeholder="مقدار روز">
            </div>
          </div>
          <div class="mt-10 flex flex-col md:flex-row gap-5">
            <div class="flex flex-col md:w-1/2">
              ...
              <input type="text" class="border border-gray-400 rounded-lg shadow-lg mt-2 w-full p-2 focus:outline-gray-400" placeholder="تومان">
            </div>
            <div class="flex flex-col md:w-1/2">
              <label for="" class="text-gray-800 text-sm">
                قیمت بعد از تخفیف:
