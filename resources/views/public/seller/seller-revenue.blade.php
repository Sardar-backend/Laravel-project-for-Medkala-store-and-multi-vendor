        ...
        <div class="lg:w-4/12 bg-white rounded-lg drop-shadow-lg border p-3 pt-5 h-fit">
          ...
          <div class="grid grid-cols-1 gap-4 mt-6">
            <a href="" class="border border-gray-300 p-3 rounded-md text-gray-800 text-sm hover:bg-gray-200 transition">
              محصول گوشی اپل 32g با قیمت 32,000,000 تومان به فروش رفت.
            </a>
            <a href="" class="border border-gray-300 p-3 rounded-md text-gray-800 text-sm hover:bg-gray-200 transition">
              یخچال ساید با قیمت 120,000,000 تومان به فروش رفت.
            </a>
            <a href="" class="border border-gray-300 p-3 rounded-md text-gray-800 text-sm hover:bg-gray-200 transition">
              فروش محصول هنذفری بلوتوثی تسکو با 686,000 تومان.
            </a>
          </div>
        </div>
        <!-- left -->
  ...
  <script>
    ...
    new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          label: 'درآمد شما',
          data: [7680000, 19580000, 24657000, 23475000, 16587000, 32237000],
          borderWidth: 2,
